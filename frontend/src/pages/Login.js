            ...
            <div className="bg-white p-4 p-md-5 rounded shadow-sm">
                ...
                <div className="row gy-3 gy-md-4 overflow-hidden">
                  ...
                  <div className="col-12">
                    <div className="d-grid">
                      <input type="submit" className="btn btn-lg btn-primary" value="Log in now" />
                    </div>
                  </div>
                </div>
              </form>
              <div className="row">
                <div className="col-12">
                  ...
                  <div className="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-between">
                    <Link to="/signup" className="">
                      <span className="me-1">Not having an account?</span>
                      Sign up
                    </Link>
